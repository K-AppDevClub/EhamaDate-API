...
class SpotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create spot" do
    assert_difference('Spot.count') do
      post spots_url, params: { spot: { lat: @spot.lat, lng: @spot.lng, name: @spot.name } }, as: :json
    end
  ...
  test "should update spot" do
    patch spot_url(@spot), params: { spot: { lat: @spot.lat, lng: @spot.lng, name: @spot.name } }, as: :json
    assert_response 200
  end
